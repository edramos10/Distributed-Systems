...
#define PMIX_CONFIGURE_CLI " \'--disable-man-pages\' \'--disable-debug\' \'--with-pmix-symbol-rename=OPAL_MCA_PMIX3X_\' \'--enable-embedded-mode\' \'--disable-pmix-timing\' \'--without-tests-examples\' \'--disable-pmix-binaries\' \'--disable-pmix-backward-compatibility\' \'--disable-visibility\' \'--enable-embedded-libevent\' '--with-libevent-header=\"opal/mca/event/external/external.h\"' \'--enable-embedded-hwloc\' '--with-hwloc-header=\"opal/mca/hwloc/external/external.h\"' \'--prefix=/home/edramos/.openmpi\' \'CFLAGS=-O3 -DNDEBUG  \' \'CPPFLAGS=-I/home/edramos/Documents/Distributed-Systems/openmpi-4.1.1 -I/home/edramos/Documents/Distributed-Systems/openmpi-4.1.1 -I/home/edramos/Documents/Distributed-Systems/openmpi-4.1.1/opal/include -I/home/edramos/Documents/Distributed-Systems/openmpi-4.1.1/opal/include    \' \'--cache-file=/dev/null\' \'--srcdir=.\' \'--disable-option-checking\'"

/* Date when PMIx was built */
#define PMIX_CONFIGURE_DATE "2023-02-09T17:22:03"

/* Hostname where PMIx was built */
#define PMIX_CONFIGURE_HOST "edramos-nitro5"
...
#define PMIX_PACKAGE_STRING "PMIx root@edramos-nitro5 Distribution"
